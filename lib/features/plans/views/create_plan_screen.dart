          ...
          () => controller.isLoading.value
              ...
              : SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      Text('Plan Type', style: Theme.of(context).textTheme.titleMedium),
                      DropdownButton<String>(
                        value: controller.selectedPlanType.value,
                        isExpanded: true,
                        items: AppConstants.planTypes
                      ...
                      const SizedBox(height: 16),
                      Text('Duration (weeks)', style: Theme.of(context).textTheme.titleMedium),
                      TextField(
                      ...
                      Wrap(
                        ...
                        children: AppConstants.fitnessGoals.map((goal) {
                          return Obx(() => FilterChip(
                                label: Text(goal),
                                selected: controller.selectedGoals.contains(goal),
                                onSelected: (selected) {
                                  if (selected) {
                                  ...
                                  print('Goals updated: ${controller.selectedGoals}');
                                },
                              ));
                        }).toList(),
                      ),
                      ...
                      Obx(() => Wrap(
                            spacing: 8.0,
                            children: controller.mediaFiles
                                .map((file) => Chip(
